...
namespace TorrentSpider
{
    public class Worker : BackgroundService
    {
        ...
        {
            lock (listener)
                listener.WriteLine ($"找到 {e.NewPeers} 位新的共享者,有 {e.ExistingPeers} 位公共想者退出.");//throw new Exception("The method or operation is not implemented.");
        }
