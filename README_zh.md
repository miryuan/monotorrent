...
这是BEP协议列表,以下协议已在MonoTorrent中实现.想要了解BEP的所有协议请前往[here](http://www.bittorrent.org/beps/bep_0000.html)
...
* BEP 5  - [DHT Protocol(DHT协议)](http://www.bittorrent.org/beps/bep_0005.html)
...
客户端下载Torrent并具有广泛的功能。

* 特定文件的优先级
* 选择性文件下载 (包括不下载特定文件的能力).
* Rarest first piece picking (考虑优先级).
